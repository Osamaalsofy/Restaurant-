import { FloatingFoodHero } from '@/src/components/ui/hero-section-7';
...
export default function HeroSection({ onExploreClick, onCustomMixClick }: HeroSectionProps) {
  ...
  const titleText = language === 'en' 
    ? "Botanical Kitchen Sanctuary"
    : "بلانتيفاي ملاذ الطهي النباتي";
    
  const descText = language === 'en'
    ? "A zero-mile exploratory dining experience. Discover organic wood-fired dishes and custom-crafted physiological elixirs from our gardens."
    : "تجربة طهي استكشافية متكاملة. اكتشف الأطباق النباتية المحمرة على جمر الحطب والترياق والكوكتيلات العضوية المصممة بعناية.";
  ...
  return (
    <div className="w-full">
      <FloatingFoodHero
        ...
        onCustomMixClick={onCustomMixClick}
      />
    </div>
  );
}
